...
public class OnboardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Checking for first time launch, if the app is launched for the first time, onboarding is shown
        // onboarding won't show up on other launches
        ...
        dotsLayout = (LinearLayout) findViewById(R.id.onboardingDots);
